...
if not a in dict_num:
    ...
    print("I am not able to answer this question. Check your input.")
# FC comment - this should be an "and", not an "or"
elif b != 'plus' or b != 'minus':
    print("I am not able to answer this question. Check your input.")
else:
    # FC comment - need to extend this list to ten. Also need to deal with negative numbers
    number_to_text = ['zero', 'one', 'two', 'three', 'four', 'five']

    num_a = dict_num [a]
    num_c = dict_num [c]

    # FC comment - don't need to define result here 
    result = 0
    if b == 'plus':
        result = num_a + num_c
    else:
